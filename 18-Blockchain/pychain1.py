...
################################################################################
# Step 1:
# Create a Record Data Class - DONE 
...
# 1. Define a new class named `Record`. DONE 
# 2. Add the `@dataclass` decorator immediately before the `Record` class
# definition. DONE 
# 3. Add an attribute named `sender` of type `str`. DONE 
# 4. Add an attribute named `receiver` of type `str`. DONE 
# 5. Add an attribute named `amount` of type `float`. DONE 
...
st.markdown("## Store Data in the PyChain")
